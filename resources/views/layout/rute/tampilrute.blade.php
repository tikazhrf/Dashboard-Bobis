                ...
                @csrf
                  <div class="card-body">
                    <div class="row">
                        ...
                        <div class="form-group col-6">
                            <label>Origin</label>
                            <input type="text" name="origin" class="form-control" required="" value="{{ $data->origin }}">
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="form-group col-6">
                            ...
                            <input type="text" name="destination" class="form-control" required="" value="{{ $data->destination }}">
                        </div>
                        <div class="form-group col-6">
                            <label>Price</label>
                            <div class="input-group">
                              ...
                              <input type="number" name="price" class="form-control currency" value="{{ $data->price }}">
                            </div>
                          </div>
                    </div>
