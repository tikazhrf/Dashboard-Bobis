                  ...
                  <div class="card-body">
                    <div class="row">
                      <div class="form-group col-6">
                        <label>PO Name</label>
                        <input type="text" name="namapo" class="form-control" required="" value="{{ $data->namapo }}">
                      </div>
                      <div class="form-group col-6">
                          <label>Logo</label>
                    ...
                    <div class="row">
                        <div class="form-group col-6">
                            ...
                            <input type="text" name="code_bus" class="form-control" required="" value="{{ $data->code_bus }}">
                        </div>
                        <div class="form-group col-6">
                          <label>VIN</label>
                          <input type="text" name="vin" class="form-control" required="" value="{{ $data->vin }}">
                      </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="form-group col-6">
                            ...
                            <input type="text" name="plate_number" class="form-control" required="" value="{{ $data->plate_number }}">
                        </div>
                        <div class="form-group col-6">
                          <label>BPKB Expired</label>
                          <input type="date" name="bpkb_expired" class="form-control" required="" value="{{ $data->bpkb_expired }}">
                      </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="form-group col-6">
                            <label>Driver</label>
                            <input type="text" name="driver" class="form-control" required="" value="{{ $data->driver }}">
                        </div>
                        <div class="form-group col-6">
                          <label>Seat</label>
                          <input type="number" name="seat" class="form-control" required="" value="{{ $data->seat }}">
                      </div>
                    </div>
