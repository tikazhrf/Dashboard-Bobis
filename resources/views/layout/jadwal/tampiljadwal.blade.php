                  ...
                  <div class="card-body">
                    ...
                    <div class="row">
                        <div class="form-group col-6">
                            ...
                            <input type="time" name="start_at" class="form-control" required="" value="{{ $data->start_at }}">
                        </div>
                        <div class="form-group col-6">
                            <label>End At</label>
                            <input type="time" name="end_at" class="form-control" required="" value="{{ $data->end_at }}">
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="form-group col-6">
                            ...
                            <input type="text" name="duration_journey" class="form-control" required="" value="{{ $data->duration_journey }}">
                        </div>
                         <div class="form-group col-6">
                          <label class="d-block">Operation Day</label>
                          <div class="form-check form-check-inline">
                            <input class="form-check-input" name="operation_day[]" type="checkbox" id="inlineCheckbox1" value="Monday">
                            <label class="form-check-label" for="inlineCheckbox1">Monday</label>
                          </div>
                          <div class="form-check form-check-inline">
                            <input class="form-check-input" name="operation_day[]" type="checkbox" id="inlineCheckbox2" value="Tuesday">
                            <label class="form-check-label" for="inlineCheckbox2">Tuesday</label>
                          </div>
                          <div class="form-check form-check-inline">
                            <input class="form-check-input" name="operation_day[]" type="checkbox" id="inlineCheckbox3" value="Wednesday">
                            <label class="form-check-label" for="inlineCheckbox3">Wednesday</label>
                          </div>
                          <div class="form-check form-check-inline">
                            <input class="form-check-input" name="operation_day[]" type="checkbox" id="inlineCheckbox4" value="Thursday">
                            <label class="form-check-label" for="inlineCheckbox4">Thursday</label>
                          </div>
                          <div class="form-check form-check-inline">
                            <input class="form-check-input" name="operation_day[]" type="checkbox" id="inlineCheckbox5" value="Friday">
                            <label class="form-check-label" for="inlineCheckbox5">Friday</label>
                          </div>
                          <div class="form-check form-check-inline">
                            <input class="form-check-input" name="operation_day[]" type="checkbox" id="inlineCheckbox6" value="Saturday">
                            <label class="form-check-label" for="inlineCheckbox6">Saturday</label>
                          </div>
                          <div class="form-check form-check-inline">
                            <input class="form-check-input" name="operation_day[]" type="checkbox" id="inlineCheckbox7" value="Sunday">
